...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C01401();
    ...
    class C01401 implements Comparator<String> {
        C01401() {
        }
    ...
    class C01412 implements ThreadFactory {
        final /* synthetic */ boolean val$daemon;
        final /* synthetic */ String val$name;

        C01412(String str, boolean z) {
            this.val$name = str;
            this.val$daemon = z;
        }
