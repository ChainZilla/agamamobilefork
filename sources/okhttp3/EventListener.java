...
public abstract class EventListener {
    public static final EventListener NONE = new C02581();
    ...
    class C02581 extends EventListener {
        C02581() {
        }
    }

    /* renamed from: okhttp3.EventListener$2 */
    class C02592 implements Factory {
        final /* synthetic */ EventListener val$listener;

        C02592(EventListener eventListener) {
