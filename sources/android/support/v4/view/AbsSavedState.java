...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C02322());
    public static final AbsSavedState EMPTY_STATE = new C02311();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C02311 extends AbsSavedState {
        C02311() {
            super();
        }
    }
    ...
    static class C02322 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C02322() {
        }
