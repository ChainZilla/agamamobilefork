...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00961();
    ...
    private static final Interpolator sInterpolator = new C00972();
    ...
    private final Runnable mEndScrollRunnable = new C00983();
    ...
    static class C00961 implements Comparator<ItemInfo> {
        C00961() {
        }
    ...
    static class C00972 implements Interpolator {
        C00972() {
        }
    ...
    class C02364 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02364());
    }
