...
public class CoreAndroid extends CordovaPlugin {
    ...
    class C01713 implements Runnable {
        C01713() {
        }
    ...
    class C01735 extends BroadcastReceiver {
        C01735() {
        }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        try {
            if (action.equals("clearCache")) {
                ...
                this.cordova.getActivity().runOnUiThread(new C01691());
    ...
    public void clearCache() {
        this.cordova.getActivity().runOnUiThread(new C01702());
    }
    ...
    public void clearHistory() {
        this.cordova.getActivity().runOnUiThread(new C01713());
    }

    public void backHistory() {
        this.cordova.getActivity().runOnUiThread(new C01724());
    }
    ...
    private void initTelephonyReceiver() {
        ...
        this.telephonyReceiver = new C01735();
    ...
    public static Object getBuildConfigValue(Context ctx, String key) {
        ...
        try {
            ...
            LOG.m9d(TAG, "Unable to get the BuildConfig, is this built with ANT?");
            e.printStackTrace();
        } catch (NoSuchFieldException e2) {
            LOG.m9d(TAG, key + " is not a valid field. Check your build.gradle");
        } catch (IllegalAccessException e3) {
            LOG.m9d(TAG, "Illegal Access Exception: Let's print a stack trace.");
            e3.printStackTrace();
        }
        return obj;
    }
