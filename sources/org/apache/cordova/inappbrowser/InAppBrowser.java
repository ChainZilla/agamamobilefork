...
public class InAppBrowser extends CordovaPlugin {
    ...
    class C01865 implements Runnable {
        ...
        class C01851 extends WebViewClient {
            C01851() {
            }
        ...
        public void run() {
            ...
            if (childView != null) {
                childView.setWebViewClient(new C01851());
                ...
                try {
                    ...
                    LOG.m9d(InAppBrowser.LOG_TAG, "Should never happen");
                }
            }
        }
    }
    ...
    public class InAppBrowserClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (url.startsWith("http:") || url.startsWith("https:") || url.startsWith("file:")) {
                ...
                LOG.m12e(InAppBrowser.LOG_TAG, "Possible Uncaught/Unknown URI");
                newloc = "http://" + url;
            }
            ...
            try {
                ...
                LOG.m12e(InAppBrowser.LOG_TAG, "URI passed in has caused a JSON error.");
            }
        }
        ...
        public void onReceivedHttpAuthRequest(WebView view, HttpAuthHandler handler, String host, String realm) {
            ...
            try {
                ...
                LOG.m9d(InAppBrowser.LOG_TAG, e.getLocalizedMessage());
            } catch (IllegalAccessException e2) {
                LOG.m9d(InAppBrowser.LOG_TAG, e2.getLocalizedMessage());
            } catch (InvocationTargetException e3) {
                LOG.m9d(InAppBrowser.LOG_TAG, e3.getLocalizedMessage());
            }
            if (pluginManager == null) {
                try {
                    pluginManager = (PluginManager) this.webView.getClass().getField("pluginManager").get(this.webView);
                } catch (NoSuchFieldException e4) {
                    LOG.m9d(InAppBrowser.LOG_TAG, e4.getLocalizedMessage());
                } catch (IllegalAccessException e22) {
                    LOG.m9d(InAppBrowser.LOG_TAG, e22.getLocalizedMessage());
                }
            }
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        if (action.equals("open")) {
            ...
            LOG.m9d(LOG_TAG, "target = " + target);
            final CallbackContext callbackContext2 = callbackContext;
            this.cordova.getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    String result = "";
                    if (InAppBrowser.SELF.equals(target)) {
                        LOG.m9d(InAppBrowser.LOG_TAG, "in self");
                        ...
                        if (shouldAllowNavigation == null) {
                            try {
                                ...
                                LOG.m9d(InAppBrowser.LOG_TAG, e32.getLocalizedMessage());
                            }
                        }
                        if (Boolean.TRUE.equals(shouldAllowNavigation)) {
                            LOG.m9d(InAppBrowser.LOG_TAG, "loading in webview");
                            InAppBrowser.this.webView.loadUrl(url);
                        } else if (url.startsWith("tel:")) {
                            try {
                                LOG.m9d(InAppBrowser.LOG_TAG, "loading in dialer");
                                Intent intent = new Intent("android.intent.action.DIAL");
                                intent.setData(Uri.parse(url));
                                InAppBrowser.this.cordova.getActivity().startActivity(intent);
                            } catch (ActivityNotFoundException e5) {
                                LOG.m12e(InAppBrowser.LOG_TAG, "Error dialing " + url + ": " + e5.toString());
                            }
                        } else {
                            LOG.m9d(InAppBrowser.LOG_TAG, "loading in InAppBrowser");
                            result = InAppBrowser.this.showWebPage(url, features);
                        }
                    } else if (InAppBrowser.SYSTEM.equals(target)) {
                        LOG.m9d(InAppBrowser.LOG_TAG, "in system");
                        result = InAppBrowser.this.openExternal(url);
                    } else {
                        LOG.m9d(InAppBrowser.LOG_TAG, "in blank");
                        result = InAppBrowser.this.showWebPage(url, features);
                    }
            ...
            this.cordova.getActivity().runOnUiThread(new C01822());
            ...
            this.cordova.getActivity().runOnUiThread(new C01833());
            pluginResult = new PluginResult(Status.OK);
            pluginResult.setKeepCallback(true);
            this.callbackContext.sendPluginResult(pluginResult);
        }
    ...
    private void injectDeferredObject(String source, String jsWrapper) {
        ...
        LOG.m9d(LOG_TAG, "Can't inject code into the system browser");
    }
    ...
    public String openExternal(String url) {
        ...
        try {
            ...
            try {
                ...
                LOG.m9d(LOG_TAG, "InAppBrowser: Error loading url " + url + ":" + e.toString());
                return e.toString();
            }
    ...
    public void closeDialog() {
        this.cordova.getActivity().runOnUiThread(new C01865());
    }
    ...
    public String showWebPage(final String url, HashMap<String, Boolean> features) {
        ...
        if (features != null) {
            ...
            Boolean wideViewPort = (Boolean) features.get(USER_WIDE_VIEW_PORT);
            if (wideViewPort != null) {
                this.useWideViewPort = wideViewPort.booleanValue();
            }
        }
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            class C01893 implements OnKeyListener {
                C01893() {
                }
            ...
            public void run() {
                ...
                back.setOnClickListener(new C01871());
                ...
                linearLayout.setOnClickListener(new C01882());
                ...
                InAppBrowser.this.edittext.setOnKeyListener(new C01893());
                ...
                close.setOnClickListener(new C01904());
                ...
                InAppBrowser.this.inAppWebView.setWebChromeClient(new InAppChromeClient(thatWebView) {
                    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                        LOG.m9d(InAppBrowser.LOG_TAG, "File Chooser 5.0+");
                        if (InAppBrowser.this.mUploadCallbackLollipop != null) {
                            InAppBrowser.this.mUploadCallbackLollipop.onReceiveValue(null);
                        }
                        InAppBrowser.this.mUploadCallbackLollipop = filePathCallback;
                        Intent content = new Intent("android.intent.action.GET_CONTENT");
                        content.addCategory("android.intent.category.OPENABLE");
                        content.setType("*/*");
                        InAppBrowser.this.cordova.startActivityForResult(InAppBrowser.this, Intent.createChooser(content, "Select File"), 2);
                        return true;
                    }

                    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                        LOG.m9d(InAppBrowser.LOG_TAG, "File Chooser 4.1+");
                        openFileChooser(uploadMsg, acceptType);
                    }

                    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                        LOG.m9d(InAppBrowser.LOG_TAG, "File Chooser 3.0+");
                        InAppBrowser.this.mUploadCallback = uploadMsg;
                        Intent content = new Intent("android.intent.action.GET_CONTENT");
                        content.addCategory("android.intent.category.OPENABLE");
                        InAppBrowser.this.cordova.startActivityForResult(InAppBrowser.this, Intent.createChooser(content, "Select File"), 1);
                    }
                });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (VERSION.SDK_INT >= 21) {
            LOG.m9d(LOG_TAG, "onActivityResult (For Android >= 5.0)");
            if (requestCode != 2 || this.mUploadCallbackLollipop == null) {
                super.onActivityResult(requestCode, resultCode, intent);
                return;
            }
            this.mUploadCallbackLollipop.onReceiveValue(FileChooserParams.parseResult(resultCode, intent));
