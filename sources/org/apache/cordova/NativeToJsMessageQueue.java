...
public class NativeToJsMessageQueue {
    ...
    public static class OnlineEventsBridgeMode extends BridgeMode {
        ...
        public void reset() {
            this.delegate.runOnUiThread(new C01761());
        }
    ...
    public void setBridgeMode(int value) {
        if (value < -1 || value >= this.bridgeModes.size()) {
            LOG.m9d(LOG_TAG, "Invalid NativeToJsBridgeMode: " + value);
            return;
        }
        BridgeMode newMode = value < 0 ? null : (BridgeMode) this.bridgeModes.get(value);
        if (newMode != this.activeBridgeMode) {
            LOG.m9d(LOG_TAG, "Set native->JS mode to " + (newMode == null ? "null" : newMode.getClass().getSimpleName()));
            synchronized (this) {
    ...
    public void addPluginResult(PluginResult result, String callbackId) {
        if (callbackId == null) {
            LOG.m13e(LOG_TAG, "Got plugin result with no callbackId", new Throwable());
            return;
        }
    ...
    L_0x0005:
        ...
        org.apache.cordova.LOG.m9d(r0, r1);	 Catch:{ all -> 0x001e }
    ...
    public void setPaused(boolean value) {
        if (this.paused && value) {
            LOG.m13e(LOG_TAG, "nested call to setPaused detected.", new Throwable());
        }
        this.paused = value;
        if (!value) {
            synchronized (this) {
